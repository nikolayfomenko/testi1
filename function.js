...
function creatAnswer(){
		...
		ae.style.width=13 + "%";
		ae.style.height = 23 + "%";
		ae.style.backgroundImage = "url(ae.jpg)";
...
function creatAnswer2(){
		...
		ug.style.width=13 + "%";
		ug.style.height = 23 + "%";
		ug.style.backgroundImage = "url(ug.jpeg)";
...
function creatAnswer3(){
		...
		eif.style.width=13 + "%";
		eif.style.height = 23 + "%";
		eif.style.backgroundImage = "url(eif.jpg)";
...
function creatAnswer4(){
		...
		lotr.style.backgroundImage = "url(lotr.jpg)";
...
function creatAnswer5(){
		...
		mv.style.width=13 + "%";
		mv.style.height = 23 + "%";
		mv.style.backgroundImage = "url(mv.jpg)";
...
function creatAnswer6(){
		...
		piram.style.backgroundImage = "url(piram.jpg)";
...
function creatAnswer7(){
		...
		hr.style.width=13 + "%";
		hr.style.height = 23 + "%";
		hr.style.backgroundImage = "url(hr.jpg)";
